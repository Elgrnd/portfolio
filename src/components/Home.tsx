                        ...
                        <div>
                            ...
                            <p className="text-gray-600">
                                ...
                                <br></br><br></br>
                                    ...
                                    j'aime consacrer du
                                    temps au <strong>développement de projets personnels</strong>. J'ai également
                                    pratiqué le <strong>football</strong>
                                    ...
                                    <br><br>
                                        ...
                                        dans ce domaine en constante innovation.</br></br>
                            </p>
                        </div>
                        <div>
